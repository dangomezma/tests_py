import pytest
from passwort import (is_valid_password,is_over_8,has_caps,has_minuscule,has_no_blanks,has_num)
...
def test_is_valid_password():
    ...
    assert not is_valid_password("AAbcdefg")
    assert not is_valid_password("AAbc 12345")
